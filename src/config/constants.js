...
const AUDIT_ACTIONS = {
  ...
  QUOTATION_SUBMITTED_FOR_APPROVAL: "quotation.submitted_for_approval",
  QUOTATION_APPROVED: "quotation.approved",
  QUOTATION_APPROVAL_REJECTED: "quotation.approval_rejected",
  INVOICE_CREATED: "invoice.created",
  INVOICE_SUBMITTED_FOR_APPROVAL: "invoice.submitted_for_approval",
  ...
  FOLLOWUP_TEMPLATE_CREATED: "followup.template_created",
  FOLLOWUP_TEMPLATE_UPDATED: "followup.template_updated",
  FOLLOWUP_TEMPLATE_DELETED: "followup.template_deleted",
...
const CONSOLIDATED_BOM_STATUSES = [
  "draft",
  "sent_to_vendor",
  "vendor_submitted",
  "approved",
