...
exports.updateProfile = asyncHandler(async (req, res) => {
  const { name, firstName, lastName, email, phone, countryCode, mobile, photo } = req.body

  const hasUpdate = [name, firstName, lastName, email, phone, countryCode, mobile, photo]
    .some((value) => value !== undefined)
  if (!hasUpdate) {
    return badRequest(res, 'No updatable fields provided — send name, email, phone, mobile, or photo')
  }
