...
const scheduleFollowUpReminder = (followUp) => {
  ...
  const jobDate = new Date(
    followUpDate.getTime() - Math.max(0, reminderMinutes) * 60 * 1000,
  );
  ...
  // Only fire exactly reminderMinutes before follow-up time. Never emit early/now.
