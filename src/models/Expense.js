...
const EXPENSE_DEPARTMENTS = ['Sales', 'Plant', 'Construction', 'Support']
...
const ExpenseSchema = new mongoose.Schema(
  {
    ...
    department:    { type: String, enum: EXPENSE_DEPARTMENTS, default: null },
...
module.exports.EXPENSE_DEPARTMENTS = EXPENSE_DEPARTMENTS
